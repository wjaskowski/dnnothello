...
def create_dnn_agent(model_dir, model_name, channels, board_encoder, input_size=8, batch_size=1, model_iter=30000, gpu=1):
    """
    :param channels:
    :param board_encoder:
    """
    ...
    def dnn_agent(board, my_color):
        ...
        probabilities = predict(net, [board_encoder(board[1:-1, 1:-1], my_color)])[0]
