...
def parse_log(path_to_log):
    ...
    return pd.DataFrame.from_records(train_dict_list, index='NumIters'), \
           pd.DataFrame.from_records(test_dict_list, index='NumIters'), batch_size
...
def main():
    ...
    train_dict_list, test_dict_list = parse_log('/home/pliskowski/Documents/experiments/othello/18-11-2015/no_pool_exp2e/cnn_nopool/log.txt')
